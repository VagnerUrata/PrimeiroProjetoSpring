...
public class Usuario implements UserDetails {
	...
	@JoinTable(name = "REL_USUARIOS_ROLES", joinColumns = { @JoinColumn(name = "LOGIN") }, inverseJoinColumns = {
	...
	public Collection<? extends GrantedAuthority> getAuthorities() {
		...
		this.permissoes.stream().forEach(perm -> {
			GrantedAuthority authority = new SimpleGrantedAuthority(perm.getNomePermissao());
